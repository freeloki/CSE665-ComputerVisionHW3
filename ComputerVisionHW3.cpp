...
void processVideo(char* videoFilename) {
    ...
    while( keyboard != 'q' && keyboard != 27 ){
      ...
      //  bilateralFilter(fgMaskMOG2, blurredFrame, 9, 25, 25, BORDER_DEFAULT);

    //  medianBlur(fgMaskMOG2, blurredFrame, 5);

    //blur( fgMaskMOG2, blurredFrame, Size( 5, 5 ), Point(-1,-1) );
        ...
        for( int i = 0; i< contours.size(); i++ ) // iterate through each contour.
      {
        ...
        cv::imwrite("ColorContour_" + std::to_string(totalContours) + ".jpg", roi);
        totalContours++;
      } else {
