...
tf.app.flags.DEFINE_string('output_directory', '/mnt/Linux-Extended/DEVELOPMENT/GIT/CSE665-ComputerVisionHW3/tf_output', 'Output data directory')
...
def cnn_model_fn(features, labels, mode):
    ...
    print('Hlllooeee')
    print('labelsss:%s' %labels)
    # Input Layer
    f = features["image"]
    input_layer = tf.reshape(f, [100, 252, 252, 3])
